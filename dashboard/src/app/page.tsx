...
export default function Dashboard() {
  ...
  const handleCreateToken = async (data: { contractor_email: string; credential_name: string; target_url: string; duration_hours: number; allowed_ip?: string; is_one_time?: boolean }) => {
